...
| **2604.13253** — BC-ACI (Lade, Krishna, Kumar, Apr 2026) | per-horizon online EWMA bias estimate; corrects scores and re-centres intervals | W2 | **NO — Q13 CLOSED.** Nearest neighbour on the W2 axis, but it moves the interval *centre* while we condition the interval *width* on horizon-bucket × channel. No channel dimension, no bucketing, no worst-cell audit, no decision layer |
...
have not measured it. This is Reviewer #2 item **RV16** and open question **Q20**. It is one pass
...
appears to have been missed (Q15).
...
Q05 (could the survey pre-empt W1) and Q13 (does BC-ACI occupy W2) — are both closed, and both
